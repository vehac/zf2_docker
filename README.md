...
Docker
---------------
Docker - ZendFramework 2 (PHP 5.6) - MariaDB - MongoDB - Memcached (2.2.0)
...
```
- Para instalar dependecias con composer, ejecutar lo siguiente dentro del contenedor con docker:
```bash
composer install
```
- Para ver la web:
